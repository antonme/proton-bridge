...
const (
	fetchMessagesWorkers    = 100 // In how many workers to fetch message (group list on IMAP).
	fetchAttachmentsWorkers = 50  // In how many workers to fetch attachments (for one message).
